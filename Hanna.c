...
int main()
{
	int dice_pool[] = { 2, 2, 3, 3, 3 };
	int num = sizeof(dice_pool) / sizeof(dice_pool[0]);
	print_pool(dice_pool, num);
	printf("\n");

	printf("1 * num: %d", find_num_in_pool(dice_pool, num, 1));
	printf("\n");
	printf("2 * num: %d", find_num_in_pool(dice_pool, num, 2));
	printf("\n");
	printf("3 * num: %d", find_num_in_pool(dice_pool, num, 3));
	printf("\n");
	printf("4 * num: %d", find_num_in_pool(dice_pool, num, 4));
	printf("\n");
	printf("5 * num: %d", find_num_in_pool(dice_pool, num, 5));
	printf("\n");
	printf("6 * num: %d", find_num_in_pool(dice_pool, num, 6));
	printf("\n");

	printf("num * 3: %d", x_of_a_kind(dice_pool, num, 3));
	printf("\n");
	printf("num * 4: %d", x_of_a_kind(dice_pool, num, 4));
	printf("\n");
	printf("num * 5: %d", x_of_a_kind(dice_pool, num, 5));
	printf("\n");

	printf("Small straight: %d", check_small_straingt(dice_pool, num));
	printf("\n");
	printf("Large straight: %d", check_large_straingt(dice_pool, num));
	printf("\n");

	printf("1 pair: %d",check_pairs(dice_pool, num, 1));
	printf("\n");
	printf("2 pairs: %d",check_pairs(dice_pool, num, 2));
	printf("\n");

	printf("Full house: %d", check_full_house(dice_pool, num));
}
